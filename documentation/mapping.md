...
| 2 | `<name>`  | [`<title>` ](https://datacite-metadata-schema.readthedocs.io/en/4.7/properties/title/)| `<name>` (ID 2)  | `<name>` (ID 3), `<sample_other_names>` (ID 77), `<sample_other_name>` (ID 77.1) | -  |
...
| 5.2 | `<publicationYear>`   | [`<publicationYear>`](https://datacite-metadata-schema.readthedocs.io/en/4.7/properties/publicationyear/#publicationyear)   | -  | `<publish_date>` (ID 10), `@publishdate` (ID 79.1.4) | `@timeStamp` (ID 4.1.2)  |
| 6 | `<access>`  | -  | `<sampleAccess>` (ID 16) | `<is_privat>` (ID 6) | -  |
| 6.1 | `@accessType` | - | `<sampleAccess>` (ID 16) | `<is_privat>` (ID 6) | -  |
| 7 | `<archives>`  | - | -  | `<current_archive>` (ID 64), `<original_archive>` (ID 66)  | -  |
| 7.1 | `<archiveName>` | - | -  | `<current_archive>` (ID 64), `<original_archive>` (ID 66)  | -  |
| 7.1.1 | `@lang` |  -  | -  | -  | -  |
| 7.1.2 | `<nameIdentifier>`  | -  | `<identifier>` (ID 9.1), `<identifier>` (ID 10.1.2)  | `<sampled_by>` (ID 8), `<collector_detail>` (ID 60)  | -  |
| 7.1.2.1 |  `@nameIdentifierScheme` | - | `@type` (ID 10.1.2.1), `@type` (ID 9.1.1), `@type` (ID 8.1.1)  | `<collector_detail>` (ID 60) |  `@nameIdentifierScheme` (ID 2.2.1) |
| 7.1.2.2 | `@schemeURI`  | - | `<collector>` (ID 9) | `<collector_details>` (ID 60)  | -  |
| 7.2 | `<geoLocationPlace>`  | - | -  | -  | -  |
| 7.2.1 | `@lang` |  `xml:lang`  | -  | -  | -  |
| 7.2.2 | `<nameIdentifier>`  | - | `<identifier>` (ID 9.1), `<identifier>` (ID 10.1.2)  | `<sampled_by>` (ID 8), `<collector_detail>` (ID 60)  | -  |
| 7.2.2.1 |  `@nameIdentifierScheme` | - | `@type` (ID 10.1.2.1), `@type` (ID 9.1.1), `@type` (ID 8.1.1)  | `<collector_detail>` (ID 60) |  `@nameIdentifierScheme` (ID 2.2.1) |
| 7.2.2.2 | `@schemeURI`  | - | `<collector>` (ID 9) | `<collector_details>` (ID 60)  | -  |
| 7.3 | `<geoLocationPoint>`  | - | `<geometry>` (ID 11.1.1), `@type` (ID 11.1.1.1)  | -  | -  |
| 7.3.1 | `@coordinateSystem` | - | `@sridType` (ID 11.1.1.2)  | `<coordinate_system>` (ID 15)  | -  |
| 7.3.2 | `<pointLongitude>`  | - | -  | `<longitude>` (ID 12), `<longitude_end>` (ID 14) | -  |
| 7.3.3 | `<pointLatitude>`   | - | -  | `<latitude>` (ID 11), `<latitude_end>` (ID 13) | -  |
| 7.4 | `<contributor>` | - | `<contributor>` (ID 10.1), `<contributers>` (ID 10)  | `<operators>` (ID 57)  | -  |
| 7.4.1 | `@contributorType`  | - | `@type` (ID 10.1.1)  | -  | -  |
| 7.4.2 | `<contributorName>`   | - | `<name>` (ID 10.1.2.2) | `<operator>` (ID 57.1) | -  |
| 7.4.2.1 | `@nameType` | - | `@identifier` (ID 9.3.1) | `<collector_detail>` (ID 60) | -  |
| 7.4.2.2 | `@lang` | - | -  | -  | -  |
| 7.4.3 | `<givenName>`   | -  | `<name>` (ID 9.2), `<name>` (ID 10.1.2.2)  | `<collector>` (ID 59), `<collector_detail>` (ID 60)  | -  |
| 7.4.4 | `<familyName>`  | - | `<collector>` (ID 9), `<name>` (ID 9.2), `<contributer>` (ID 10.1), `<name>` (ID 10.1.2.2) | `<collector>` (ID 59), `<collector_detail>` (ID 60)  | -  |
| 7.4.5 | `<nameIdentifier>`  | - | `<identifier>` (ID 9.1), `<identifier>` (ID 10.1.2)  | `<sampled_by>` (ID 8), `<collector_detail>` (ID 60)  | -  |
| 7.4.5.1 |  `@nameIdentifierScheme` | - | `@type` (ID 10.1.2.1), `@type` (ID 9.1.1), `@type` (ID 8.1.1)  | `<collector_detail>` (ID 60) |  `@nameIdentifierScheme` (ID 2.2.1) |
| 7.4.5.2 | `@schemeURI`  | - | `<collector>` (ID 9) | `<collector_details>` (ID 60)  | -  |
| 7.4.6 | `<affiliation>` | - | `<affilation>` (ID 8.3), `<name>` (ID 8.3.2), `<affilation>` (ID 9.3), `<name>` (ID 9.3.2) | `<collector_detail>` (ID 60) | -  |
| 7.4.6.1 | `@affiliationIdentifier`  | - | `<identifier>` (ID 8.3.1), `<identifier>` (ID 9.3.1), `<identifier>` (ID 10.1.2) | `<collector_detail>` (ID 60) | -  |
| 7.4.6.2 | `@affiliationIdentifierScheme`  | - | `@type` (ID 9.3.1.1), `@type` (ID 10.1.2.1)  | `<collector_detail>` (ID 60) | -  |
| 7.4.6.3 | `@schemeURI`  | - | `<collector>` (ID 9) | `<collector_details>` (ID 60)  | -  |
...
| 8.2 | `<parentIdentifier>`  | [`<relatedIdentifier>`](https://datacite-metadata-schema.readthedocs.io/en/4.7/properties/relatedidentifier/#relatedidentifier) | `<parentIdentifier>` (ID 4)  | `<parent_igsn>` (ID 5) | `<relatedResourceIdentifier>` (ID 3) |
| 8.2.1 | `@relationType` | [`@relationType`](https://datacite-metadata-schema.readthedocs.io/en/4.7/properties/relatedidentifier/#b-relationtype) | `@relationType` (ID 6.1.2) | `@relationType` (ID 78.3)  | `@relationType` (ID 3.2) |
| 8.2.2 | `@identifierType` | [`@relatedIdentifierType`](https://datacite-metadata-schema.readthedocs.io/en/4.7/properties/relatedidentifier/#a-relatedidentifiertype) | `@type` (ID 1.1), `@type` (ID 4.1), `@type` (ID 6.1.1) | `@relatedIdentifierType` (ID 78.2) | `<identifierType>` (ID 1.1), `@relatedIdentifierType` (ID 3.1) |
| 8.3 | `<relatedIdentifier>`   | [`<relatedIdentifier>`](https://datacite-metadata-schema.readthedocs.io/en/4.7/properties/relatedidentifier/#relatedidentifier) | `<relatedIdentifier>` (ID 6.1) | `<relatedIdentifier>` (ID 78.1)  | `<relatedResourceIdentifier>` (ID 3) |
| 8.3.1 | `@relationType` | [`@relationType`](https://datacite-metadata-schema.readthedocs.io/en/4.7/properties/relatedidentifier/#b-relationtype) | `@relationType` (ID 6.1.2) | `@relationType (ID 78.3)  | `@relationType (ID 3.2) |
| 8.3.2 | `@identifierType` | [`@relatedIdentifierType`](https://datacite-metadata-schema.readthedocs.io/en/4.7/properties/relatedidentifier/#a-relatedidentifiertype) | `@type` (ID 1.1), `@type` (ID 4.1), `@type` (ID 6.1.1) | `@relatedIdentifierType` (ID 78.2) | `<identifierType>` (ID 1.1), `@relatedIdentifierType` (ID 3.1) |
...
| 9.2.2 | `<pointLongitude>`  | [`<pointLongitude>`](https://datacite-metadata-schema.readthedocs.io/en/4.7/properties/geolocation/#pointlongitude) | -  | `<longitude>` (ID 12), `<longitude_end>` (ID 14) | -  |
| 9.2.3 | `<pointLatitude>`   | [`<pointLatitude>`](https://datacite-metadata-schema.readthedocs.io/en/4.7/properties/geolocation/#pointlatitude) | -  | `<latitude>` (ID 11), `<latitude_end>` (ID 13) | -  |
...
| 9.4.1.2 | `<pointLongitude>`  | [`<pointLongitude>`](https://datacite-metadata-schema.readthedocs.io/en/4.7/properties/geolocation/#id13)  | -  | `<longitude>` (ID 12), `<longitude_end>` (ID 14) | -  |
| 9.4.1.3 | `<pointLatitude>`   | [`<pointLatitude>`](https://datacite-metadata-schema.readthedocs.io/en/4.7/properties/geolocation/#id15) | -  | `<latitude>` (ID 11), `<latitude_end>` (ID 13) | -  |
| 10  | `<fundingReferences>`   | [`<fundingReferences>`](https://datacite-metadata-schema.readthedocs.io/en/4.7/properties/fundingreference/#fundingreference)   | -  | `<funding_agency>` (ID 58) | -  |
| 10.1  | `<fundingReference>`  | [`<fundingReference>`](https://datacite-metadata-schema.readthedocs.io/en/4.7/properties/fundingreference/#fundingreference)  | -  | `<funding_agency>` (ID 58) | -  |
| 10.1.1  | `<funderName>`  | [`<funderName>`](https://datacite-metadata-schema.readthedocs.io/en/4.7/properties/fundingreference/#fundername) | -  | `<funding_agency>` (ID 58) | -  |
| 10.1.2  | `<funderIdentifier>`  | [`<funderIdentifier>`](https://datacite-metadata-schema.readthedocs.io/en/4.7/properties/fundingreference/#funderidentifier) | -  | `<funding_agency>` (ID 58) | -  |
...
| 10.1.2.2  | `@schemeURI`  | [`<schemeURI>`](https://datacite-metadata-schema.readthedocs.io/en/4.7/properties/fundingreference/#b-schemeuri) | `<collector>` (ID 9) | `<collector_details>` (ID 60)  | -  |
| 10.1.3  | `<awardNumber>` | [`<awardNumber>`](https://datacite-metadata-schema.readthedocs.io/en/4.7/properties/fundingreference/#awardnumber) | -  | `<funding_agency>` (ID 58) | -  |
...
| 10.1.4  | `<awardTitle>`  | [`@awardTitle`](https://datacite-metadata-schema.readthedocs.io/en/4.7/properties/fundingreference/#awardtitle) | -  | -  | -  |
